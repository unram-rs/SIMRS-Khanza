...
public class DlgCariPeriksaLab extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnCetakHasilLabUtama = new javax.swing.JMenuItem();
        ...
        MnCetakHasilLabUtama.setBackground(new java.awt.Color(255, 255, 254));
        MnCetakHasilLabUtama.setFont(new java.awt.Font("Serif", 0, 11)); // NOI18N
        MnCetakHasilLabUtama.setForeground(new java.awt.Color(50, 50, 50));
        MnCetakHasilLabUtama.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnCetakHasilLabUtama.setText("Model Utama");
        MnCetakHasilLabUtama.setName("MnCetakHasilLabUtama"); // NOI18N
        MnCetakHasilLabUtama.setPreferredSize(new java.awt.Dimension(120, 26));
        MnCetakHasilLabUtama.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnCetakHasilLabUtamaActionPerformed(evt);
            }
        });
        MnCetakLab.add(MnCetakHasilLabUtama);
...
private void tbDokterKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_tbDokterKeyPressed
   if(tabMode.getRowCount()!=0){
    ...
    private void MnCetakHasilLabUtamaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnCetakHasilLabUtamaActionPerformed
        // TODO add your handling code here:
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        if(tabMode.getRowCount()==0){
            JOptionPane.showMessageDialog(null,"Maaf, data sudah habis...!!!!");
            ...
            try {        
                ps4=koneksi.prepareStatement(
                    "select periksa_lab.no_rawat, reg_periksa.no_rkm_medis,pasien.nm_pasien,pasien.no_ktp,pasien.jk,pasien.umur,petugas.nama,DATE_FORMAT(periksa_lab.tgl_periksa,'%d-%m-%Y') as tgl_periksa,periksa_lab.jam,periksa_lab.nip,"+
                    "periksa_lab.dokter_perujuk,periksa_lab.kd_dokter,concat(pasien.alamat,', ',kelurahan.nm_kel,', ',kecamatan.nm_kec,', ',kabupaten.nm_kab) as alamat,dokter.nm_dokter,DATE_FORMAT(pasien.tgl_lahir,'%d-%m-%Y') as lahir "+
                    " from periksa_lab inner join reg_periksa inner join pasien inner join petugas  inner join dokter inner join kelurahan inner join kecamatan inner join kabupaten "+
                    "on periksa_lab.no_rawat=reg_periksa.no_rawat and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and periksa_lab.nip=petugas.nip and periksa_lab.kd_dokter=dokter.kd_dokter "+
...
//                        param.put("finger2",Sequel.cariIsi("select sha1(sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?",rs.getString("nip")));  
                        ...
                        try {
                            ...
                            if(rspermintaan.next()){
                                ...
                                Valid.MyReport("rptPeriksaLabUtama.jasper","report","::[ Pemeriksaan Laboratorium ]::",param);   
                            }else{                              
        ...
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnCetakHasilLabUtamaActionPerformed
    ...
    */
    ...
    private javax.swing.JMenuItem MnCetakHasilLabUtama;
